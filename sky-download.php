...
<!-- Header with Slideshow -->
  ...
  <button class="w3-button w3-block w3-green w3-hide-large w3-hide-medium" onclick="window.open('<?php echo $download_link ?>')"><?php echo $download_title ?> - Download</button>
  <div class="mySlides w3-animate-opacity" style="display:block">
    <div class="w3-display-<?php echo $download_box ?> w3-padding w3-hide-small" style="width:35%">
      <div class="w3-black w3-opacity w3-hover-opacity-off w3-padding-large w3-round-large">
        <h1 class="w3-xlarge"><?php echo $download_title ?></h1>
        <hr class="w3-opacity">
        <p class="custom_tc"><?php echo $download_desc ?></p>
        <p><button class="w3-button w3-block w3-green w3-round" onclick="window.open('<?php echo $download_link ?>')">Download</button></p>
      </div>
    </div>
  </div>
