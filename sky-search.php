...
<div class="w3-half">
  ...
  <a href="sky-search.php?m=web" class="underthesea1 custom_color shadow_man">Web</a>&emsp;&nbsp;
  <a href="sky-search.php?m=image" class="underthesea2 custom_color shadow_man">Images</a>&emsp;&nbsp;
  <a href="sky-search.php?m=music" class="underthesea3 custom_color shadow_man">Music</a>&emsp;&nbsp;
  <a href="sky-search.php?m=video" class="underthesea4 custom_color shadow_man">Video</a>&emsp;&nbsp;
  <a href="sky-search.php?m=news" class="underthesea5 custom_color shadow_man">News</a>
...
<?php
  ...
  if($m == "news"){echo '<style>.underthesea5{text-decoration:underline;}</style>';}
...
<center><h1><span class="thin" onclick="location.href='<?php echo $template ?>'" style="cursor: pointer;" title="Go Home"><?php if (file_exists("myfiles/logo.jpg")){echo "<img src='myfiles/logo.jpg' class='w3-round txtinput' width='".$logosize."' border='0'/>";}else{echo $title;} ?></span></h1>
