...
<div class="w3-content" style="max-width:2000px;">
  ...
  <div class="w3-display-container w3-center">
    <center><br><br><br><video id="videoPlayer" style="width:100%" class="w3-round w3-round" controlsList="nodownload" autoplay autobuffer controls/></video></center>
...
for (var i = 0; i < nextVideo.length; i++) {
    ...
    playtable += "<tr><td>&nbsp;<a href='#' style='cursor: pointer;' name='track"+i+"' id='track"+i+"' onclick='skip("+i+")'><i class='fa fa-play w3-button w3-round w3-black w3-xlarge' aria-hidden='true'></i>&nbsp;"+link+"</a></td></tr>";
