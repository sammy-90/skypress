...
<!-- Navbar -->
<div>
  <div class="w3-bar w3-<?php if ($login == "on"){echo $user_color;}else{echo $pagecolor;} ?> w3-card">

<?php $m = $_GET['m']; if(!$m){$m = 'web';} ?>

<div class="w3-row  w3-padding-small w3-<?php if ($login == "on"){echo $user_color;}else{echo $footercolor;} ?>"><br>

<div class="w3-container w3-quarter w3-padding w3-<?php if ($login == "on"){echo $user_color;}else{echo $footercolor;} ?>">

<big><big><center><?php echo "$title" ?></center></big></big>
 ...
 <div id="myOverlay" class="overlay">
  <div class="overlay-content" >
    <form name="form" id="search-form" onSubmit="return searchLinks1()">
      <input type="text" style="border-top-left-radius: 5px;border-bottom-left-radius: 5px;" placeholder="What are you looking for?" name="search" list="passed-searches">
      <button name="Submit" style="border-top-right-radius: 5px;border-bottom-right-radius: 5px;" class="w3-<?php if ($login == "on"){echo $user_color;}else{echo $panelcolor;} ?>" type="submit"><i class="fa fa-search custom_tc"></i></button>
...
<div class="w3-container w3-<?php if ($login == "on"){echo $user_color;}else{echo $pagecolor;} ?>"><br>

    <center>

  <?php
  if(!isMobile()){
    if ($login == "on"){echo '<div class="w3-dropdown-hover w3-'.$color.'">';}else{echo '<div class="w3-dropdown-hover w3-'.$pagecolor.'">';}
    if ($login == "on"){echo '<i class="fa fa-bars w3-large w3-hover-opacity w3-'.$color.'"></i>';}else{echo '<i class="fa fa-bars w3-large w3-hover-opacity w3-'.$pagecolor.'"></i>';}
  }else{
    if ($login == "on"){echo '<div class="w3-dropdown-click w3-'.$color.'">';}else{echo '<div class="w3-dropdown-click w3-'.$pagecolor.'">';}
    if ($login == "on"){echo '<i class="fa fa-bars w3-large w3-hover-opacity" onclick="myFunction()" w3-'.$color.'"></i>';}else{echo '<i class="fa fa-bars w3-large w3-hover-opacity" onclick="myFunction()"  w3-'.$pagecolor.'"></i>';}
  }
  ?>
    <div id="Demo" class="w3-dropdown-content w3-bar-block <?php echo 'w3-'.$pagecolor ?> w3-animate-zoom">
    ...
    <?php
    if ($login == "on"){ 
      echo "<a href=\"#\" onclick=\"document.getElementById('my_account').style.display='block'\">Hello, ".$name."</a>&emsp;&nbsp;";
    }else{
      echo "<a href=\"#\" onclick=\"Robocop(); document.getElementById('join_now').style.display='block'\">Join Now</a>&emsp;&nbsp;";
      echo "<a href=\"#\" onclick=\"Robocop(); document.getElementById('login').style.display='block'\">Sign In</a>&emsp;&nbsp;";
    }
    ?>
    ...
    <?php
    if ($login == "on"){ 
      echo "<a href=\"sky-portal-2.php?logout=out\">Log-Out</a>&emsp;&nbsp;";
      echo "<a href=\"sky-portal-login.php?mode=2&requiredemail=".$email."\">Advertise</a>&emsp;&nbsp;";
    }else{
      echo "<a href=\"#\" onclick=\"Robocop(); document.getElementById('advertiser').style.display='block'\">Advertise</a>&emsp;&nbsp;";
    }
    ?>
    <a href="search.php?User_Input=Business">Business</a>&emsp;&nbsp;
    <a href="search.php?User_Input=Entertainment">Entertainment</a>&emsp;&nbsp;
    <a href="search.php?User_Input=Finance">Finance </a>&emsp;&nbsp;
    <a href="search.php?User_Input=Life">Life</a>&emsp;&nbsp;
    <a href="search.php?User_Input=News">News</a>&emsp;&nbsp;
    <a href="search.php?User_Input=Shop">Shop</a>&emsp;&nbsp;
    <a href="search.php?User_Input=Sports">Sports</a>&emsp;&nbsp;
    <a href="search.php?User_Input=Weather">Weather</a>&emsp;&nbsp;
    </center>
...
include "sky-engine.php";
  ...
  if (isset($_GET['page'])) {
    ...
    echo '<script language="JavaScript">function Next(){top.location.href="sky-portal-2.php?i='.$i.'&page='.$_GET['page'].'";}</script>';
  }else{
    echo '<script language="JavaScript">function Next(){top.location.href="sky-portal-2.php?i='.$i.'";}</script>';
  }
...
<div class="w3-card-4 w3-rest mytopbar">
<header class="w3-container  w3-<?php if ($login == "on"){echo $user_color;}else{echo $footercolor;} ?>">
...
<div id="my_account" class="w3-modal">
  <div class="w3-modal-content w3-card-4 w3-animate-opacity">
	...
	<form method="post" action="sky-account_edit.php?link=sky-portal-2&dir=portal-members" enctype="multipart/form-data">
        <center>
        <table>
        <tr>
        <td>My Name</td>
...
<div id="join_now" class="w3-modal">
  <div class="w3-modal-content w3-card-4 w3-animate-opacity">
    ...
    <div class="w3-container"><br>
	<form method="post" onSubmit="return checkrequired(this)" action="sky-account.php?link=sky-portal-2&dir=portal-members" enctype="multipart/form-data">
        <center>
        <table>
        <tr>
        <td>My Name</td>
        ...
        <tr>
        <td>My Email</td>
        <td><input type="text" id="requiredemail" name="requiredemail" placeholder="email" maxlength="25" class="txtinput" size="40"></td> 
        </tr>
...
<div id="forgot_pass" class="w3-modal">
  <div class="w3-modal-content w3-card-4 w3-animate-opacity">
	...
	<form method="post" onSubmit="return checkrequired(this)" action="sky-forgot.php?link=sky-portal-2&dir=portal-members" enctype="multipart/form-data">
        <center>
        <table>
        <tr>
        <td>Username</td>
...
<div id="robot_check" class="w3-modal">
  <div class="w3-modal-content w3-card-4 w3-animate-opacity">
    <header class="w3-container <?php if ($login == "on"){echo 'w3-'.$color;}else{echo 'w3-'.$footercolor;} ?> w3-display-container"> 
      <span onclick="document.getElementById('robot_check').style.display='none'" class="w3-button <?php if ($login == "on"){echo 'w3-'.$color;}else{echo 'w3-'.$footercolor;} ?> w3-display-topright">X</span>
      <h4>Robot Checker</h4>
    </header>
