<?php 
    ...
    $parts = explode('/sky-window3.php',$url);
    ...
    if($_SESSION['password'] == $your_password){
      ...
      echo 'function mydelete(link){'."\r\n";
        ...
        echo 'if (r == true) {'."\r\n";
          echo 'top.location.href = "sky-admin/index-course.php?delete2="+link';
        echo '}'."\r\n";
      echo '}'."\r\n";
      echo '</script>'."\r\n";
    ...
    if ($file_count > 2){
      ...
      if($admin_mode == "on"){
        if (strpos(strtolower($file), strtolower(".txt")) !== false) {
          echo '<a href="sky-admin/index-course.php?copen='.$dir.$file.'" target="_top" oncontextmenu="mydelete(\''.$dir.$file.'\'); return false">';
        }else{
